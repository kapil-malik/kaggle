...
//        (features:Array[Double]) => Vectors.dense(features))
        
    sqc.udf.register("features", 
        (f1:Double,f2:Double,f3:Double,f4:Double,f5:Double,f6:Double,f7:Double,f8:Double,f9:Double) 
        	=> Vectors.dense(Array[Double](f1,f2,f3,f4,f5,f6,f7,f8,f9)))
